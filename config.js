...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "Prime",
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || "ᴍᴀᴄᴏᴅᴇʀ;ᴘʀɪᴍᴇ-ᴠ3;https://cdn.eypz.ct.ws/url/15-05-25_06-18_w9fi.png",
  PROCESSNAME: process.env.PROCESSNAME || "Iᴢᴜᴍɪ-ᴍᴅ",
  AUTHOR: process.env.AUTHOR || "ᴍᴀᴄᴏᴅᴇʀ",
